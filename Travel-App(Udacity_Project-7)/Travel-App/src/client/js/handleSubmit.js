...
const weatherbitkey = 'USERAPI';
const pixabayURL = 'https://pixabay.com/api/?key=';
const pixabayAPI = 'USERAPI';
...
function handleSubmit(e) {
    ...
    // // DOM interaction
    details['from'] = document.getElementById('cur_place').value;
    details['to'] = document.getElementById('des_place').value;
...
function updateUI(data) {
    trip_details_section.classList.remove('hide_details');
    ...
    if (data.daystogo < 0) {
        document.querySelector('#days_to_go_details').innerHTML = 'You have already been to the trip!';
    } else {
